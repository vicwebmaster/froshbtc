...
<head>
  ...
  <meta name="csrf-token" content="lUL057FjMpVSHMl1nvYZuVef3gNwWatt9WIIgh2a">
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo $system['sitename']; ?> - Deposit Wallet Transactions">
    
    <meta itemprop="name" content="<?php echo $system['sitename']; ?> - Deposit Wallet Transactions">
            ...
            <div class="row justify-content-center mt-2">
                <div class="col-md-12">
                    <div class="right float-right mb-5">
                        <a href="withdraw" class="btn cmn-btn mb-md-0 mb-3">Withdraw  Now                        
                        </a>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="table-responsive-md">
                        <table class="table style--two">
                            ...
                            <tbody>
								<?php $query=mysqli_query($conn, "SELECT * FROM _withdraw WHERE wUser='$userid'");
                                ...
                                <tr>
                                    ...
                                    <td data-label="Details">$1</td>
                                    <td data-label="Details"> $<?php echo $data['wAmt']-1; ?></td>
                                    <td data-label="Amount">
                                        <strong  class="text-<?php if($data['wStatus']=='Pending'){ echo 'danger'; }else{ echo 'success'; } ?>" > 
                                        <?php echo $data['wStatus']; ?>
										</strong>
                                    </td>
                                </tr>
								<?php } }else{ ?>
