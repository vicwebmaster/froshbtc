...
<head>
  ...
  <meta name="csrf-token" content="lUL057FjMpVSHMl1nvYZuVef3gNwWatt9WIIgh2a">
    <title><?php echo $system['sitename']; ?> - Deposit Wallet Transactions</title>
                ...
                <div class="col-md-12">
                    <div class="right float-right mb-5">
                        ...
                        <a href="
                                                ...
                                                ../user/transactions/interest-wallet
                    ...
                    <div class="table-responsive--md">
                        <table class="table style--two">
                            ...
                            <tbody>
                                                            <tr>
                                    <td data-label="Date">
                                        10 Oct, 2022 09:10 AM
                                    </td>
                                    <td  data-label="#Trx">9TQDUR8WMXYD</td>
                                    <td data-label="Details">You have got Sign Up Bonus</td>
                                    <td data-label="Amount">
                                        <strong  class="text-success" > + 0 USD</strong>
                                    </td>
