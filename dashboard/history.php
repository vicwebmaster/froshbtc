            ...
            <div class="row justify-content-center mt-2">
                <div class="col-md-12">
                    <div class="right float-right mb-5">
                        <a href="deposit" class="btn cmn-btn mb-md-0 mb-3">Deposit  Now                        
                        </a>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="table-responsive--md">
                        <table class="table style--two">
                            ...
                            <tbody>
								<?php $query=mysqli_query($conn, "SELECT * FROM _history WHERE hUser='$userid'");
                                ...
                                <tr>
                                    ...
                                    <td  data-label="#Trx">
                                        <?php echo $data['hGateway']; ?></td>
                                    <td data-label="Details">
                                        USD <?php echo $data['hAmt']; ?></td>
                                    <td data-label="Amount">
									
                                        <strong  class="text-<?php if($data['hStatus']=='Pending'){ echo 'danger'; }else{ echo 'success'; } ?>" > 
                                        <?php echo $data['hStatus']; ?>
										</strong>
                                    </td>
                                    <td data-label="Remaining balance">
                                        <strong>
                                        <?php echo $data['hDate']; ?></strong>
                                    </td>
                                </tr>
								<?php } }else{ ?>
								<tr>
