...
<head>
  ...
  <title><?php echo $system['sitename']; ?> - Referred Users</title>
            ...
            <div class="row justify-content-center mt-2">
                    ...
                    <div class="table-responsive">
                        <table class="table style--two">
                            ...
                            <tbody class="list">
                                <?php 
                                $uname = $clientdata['_userName'];
                                $no = 1;
                                $query=mysqli_query($conn, "select * from _users where _referredMe='$uname'");
                                if(mysqli_num_rows($query)>0){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo $data['_regTime']; ?></td>
                                    </tr>
                                 <?php  $no = $no+1; }
                                }else{ ?>
                                <tr>
                                        <td  class="text-right">No Referral Yet!</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
