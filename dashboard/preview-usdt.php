                    ...
                    <div class="card-body">
                        <ul class="list-group text-center">
                            ...
                            <li class="list-group-item p-prev-list">
                                <img src="../assets/images/gateway/qq632d98069f2701663932422.jpg"/>
                            </li>
                            ...
                            <p class="list-group-item">
                                In USDT:
                                <strong><?php echo $_SESSION['amt'].".00"; ?></strong>
                            </p>
                        </ul>

                        <a href="manual-usdt" class="btn btn-block py-3 font-weight-bold mt-4 cmn-btn">Confirm</a>
