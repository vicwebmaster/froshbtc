                        ...
                        <form id="pay" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    <p class="text-center mt-2">You have requested  <b class="text-success"><?php echo $_SESSION['amt']; ?> USD</b> , Please pay <b class="text-success"><?php echo $btcamt; ?> BNB</b>  for successful payment </p>
                                    <h4 class="text-center mb-4">Please follow the instruction below</h4>

                                    <p class="my-4 text-center"><p style="outline: 0px; margin-bottom: 1rem; color: rgb(124, 135, 152); font-family: Rubik, sans-serif; font-size: 16px;"><span style="outline: 0px; font-size: 1rem;">BNB-Wallet-Address:</span><span style="outline: 0px; font-size: 1rem;">&nbsp;</span><span style="color: white; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight:bold;">
									<?php $sendBTChere=$fetch['BNB']; echo $sendBTChere; ?></span>
                  <div class="input-group-append">
                    <span class="input-group-text copytext copyBoard" id="copyBoard"> Copy BNB Address</span>
                  </div>
...
<script>
  $("#pay").submit(function(e){
      ...
      $("#loading").show();
      $.ajax({
          url:'process/confirmPay-bnb.php',
          method: 'POST',
          dataType: 'JSON',
