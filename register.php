...
<head>
  ...
  <meta name="csrf-token" content="RjewJ7FbUGqKO9kPxi3G8VMYIu84PptVCtxZdt8H">
    <title><?php echo $system['sitename']; ?>- Register</title>
  ...
  <!-- header-section end  -->
          ...
          <div class="col-xl-5 col-lg-7">
            <div class="account-card">
              ...
              <div class="account-card__body">
                <form id="_reg" class="mt-4">                                  <div class="form-group">
    ...
    <div class="form-group">
        <input type="text" name="captcha" class="form-control" placeholder="Enter code" autocomplete="off" required>
                    ...
                    <a class="base--color" href="policy"> Privacy &amp; Policy</a>
                     ,   
                    <a class="base--color" href="terms"> Terms &amp; Condition</a>
                     </span>
                    </div>
                  </div>
                  <div class="mt-3">
                    <button type="submit" class="cmn-btn" id="signupBtn">SignUp Now</button>
...
<script>
  $("#_reg").submit(function(e){
      e.preventDefault();
      $("#signupBtn").hide();
      $("#loading").show();
      $.ajax({
          url:'dashboard/process/register.php',
          method: 'POST',
          dataType: 'JSON',
...
<!-- Mirrored from bethertrade.com/register by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Oct 2022 11:36:30 GMT -->
</html>
