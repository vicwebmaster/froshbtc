                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Minus User Fund</h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body">
                            <div class="card-body">
									...
									<div class="form-group">
										...
										<input type="number" id="amt" class="form-control" placeholder="Amount to Minus">
									</div>
                                    
                                    <button type="button" id="fundBTN" onclick="fund()" class="btn btn-primary">Minus Fund</button>
                            </div>
                        </div>
                    </div>
                </div>
