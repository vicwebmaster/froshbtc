...
<head>
  ...
  <title><?php echo $system['sitename']; ?> - Home</title>
    <meta name="description" content="<?php echo $system['sitename']; ?>, Crypto trading, nft, metaverse">
    <meta name="keywords" content="<?php echo $system['sitename']; ?>">
    ...
    <meta itemprop="image" content="assets/images/logoIcon/logo.png">
    ...
    <meta property="og:image" content="assets/images/logoIcon/logo.png"/>
...
?>
  ...
  <body>
    <!-- hero start -->
    <section class="hero bg_img" data-background="assets/images/frontend/banner/5fce371bad7db1607350043p.jpg">
      
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            <div class="hero__content">
              <h2 class="hero__title"><span class="text-white font-weight-normal">Invest for Future in Stable Platform</span> <b class="base--color">and Start Making Fast Cash</b></h2>
              <p class="text-white f-size-18 mt-3">Making money from Metaverse, Crypto, Nft, Real Estate. So, these three mainly generate the 3% profit for investors daily. But we are currently generating the company's main profit from Web 3.0 projects, Crypto Management,Real Estate, Metaverse(Virtual Lands).</p>
    ...
    <!-- hero end --> <section class="about-section pt-120 pb-120 bg_img" data-background="assets/images/frontend/about/60b60b6574cd91622543205.jpg">
      <div class="container">
        <div class="row">
    ...
    <section class="pt-120 pb-120 border-top-1">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              <h2 class="section-title"><span class="font-weight-normal">Our Services</span></h2>
              <p>A collaborative effort is one with the potential to raise the financial standards above estimation, our pension reassurance fund would keep your bank on its toes.</p>
            </div>
          </div>
        </div><!-- row end -->
        <div class="row mb-none-30">
            ...
            <div class="blog-card">
              <div class="blog-card__thumb">
                <img src="assets/images/services/realestate.jpg" alt="image">
              </div>
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="#">Real Estate Investment</a></h5>
                
                <p>Making money from Real Estate can generate high profit percentage for investors daily. You can currently generate profits from Real Estate or Metaverse(Virtual Lands).</p>
                <a href="#" class="cmn-btn btn-md mt-4">Read More</a>
              </div>
            </div>
          </div>
                    <div class="col-lg-4 col-md-6 mb-30">
            <div class="blog-card">
              <div class="blog-card__thumb">
                <img src="assets/images/services/energy.jpg" alt="image">
              </div>
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="#">Renewable Energy</a></h5>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
            <div class="blog-card">
              <div class="blog-card__thumb">
                <img src="assets/images/services/forex.jpeg" alt="image">
              </div>
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="#">Forex Trading</a></h5>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
            <div class="blog-card">
              <div class="blog-card__thumb">
                <img src="assets/images/services/commodity.png" alt="image">
              </div>
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="#">Stock and Commodities</a></h5>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
            <div class="blog-card">
              <div class="blog-card__thumb">
                <img src="assets/images/services/crypto.jpeg" alt="image">
              </div>
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="#">Cryptocurrency Investments</a></h5>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
            <div class="blog-card">
              <div class="blog-card__thumb">
                <img src="assets/images/services/cannabis.jpg" alt="image">
              </div>
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="#">Canabis and CBD</a></h5>
                
                <p>Cannabis and hemp plants contain both CBD and THC along with more than 540 other substances.</p>
                <a href="#" class="cmn-btn btn-md mt-4">Read More</a>
              </div>
            </div>
          </div>
 ...
 <section class="pt-120 pb-120" id="plan">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
        ...
        <?php $planQuery = mysqli_query($conn, "SELECT * FROM _plan WHERE _status='A'") or die(mysqli_error($conn));
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
            <div class="package-card text-center bg_img" data-background="assets/templates/bit_gold/images/bg/bg-4.png">
              ...
              <a href="javascript:void(0)" data-toggle="modal" data-target="#depoModal" data-resource="{&quot;id&quot;:25,&quot;name&quot;:&quot;Platinum Package&quot;,&quot;minimum&quot;:&quot;100000&quot;,&quot;maximum&quot;:&quot;500000&quot;,&quot;fixed_amount&quot;:&quot;0&quot;,&quot;interest&quot;:&quot;4&quot;,&quot;interest_status&quot;:&quot;1&quot;,&quot;times&quot;:&quot;24&quot;,&quot;status&quot;:&quot;1&quot;,&quot;featured&quot;:&quot;1&quot;,&quot;capital_back_status&quot;:&quot;1&quot;,&quot;lifetime_status&quot;:&quot;0&quot;,&quot;repeat_time&quot;:&quot;1&quot;,&quot;created_at&quot;:&quot;2022-09-28T15:41:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2022-09-28T15:41:23.000000Z&quot;}" class="cmn-btn btn-md mt-4 investButton">Invest Now</a>
    ...
    <section class="pt-120 pb-120 overlay--radial bg_img" data-background="assets/images/frontend/why_choose/5fce3cf364ca21607351539.jpg">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              <h2 class="section-title"><span class="font-weight-normal">Why Choose</span> <b class="base--color"><?php echo $system['sitename']; ?></b></h2>
    ...
    <section class="pt-120 pb-120">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <select class="base--bg" id="changePlan">
                       <?php  $planQuery2 = mysqli_query($conn, "SELECT * FROM _plan WHERE _status='A'") or die(mysqli_error($conn));
                       while ($planData2 = mysqli_fetch_array($planQuery2)) { ?>
                      <option value="<?php echo $planData2['_return']*$planData2['_day']; ?>" ><?php echo $planData2['_planName']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="col-lg-6">
                    <label>Invest Amount</label>
                    <input type="text" name="#0" id="planAmt" placeholder="0.00" class="form-control base--bg invest-input" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                  </div>
                  <div class="col-lg-12">
                    <label>Profit Amount</label>
                    <input type="text" class="form-control base--bg profit-input" disabled id="profitResult">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              <h2 class="section-title"><span class="font-weight-normal">How</span> <b class="base--color"><?php echo $system['sitename']; ?></b> <span class="font-weight-normal">Works</span></h2>
              ...
              <div class="tab-pane fade show active" id="deposit" role="tabpanel" aria-labelledby="deposit-tab">
                <div class="table-responsive--sm">
                  <table class="table style--two">
                    ...
                    <tbody>
					<?php $query=mysqli_query($conn, "Select * from _history join _users on _uId = hUser order by hId desc limit 10");
						if(mysqli_num_rows($query)>0){
						while($dep=mysqli_fetch_array($query)){ ?>
                      <tr>
						<td data-label="Name"><?php echo $dep['_fName']." ".$dep['_lName']; ?> </td>
                          <td data-label="Date"><?php echo $dep['hDate']; ?></td>
                          <td data-label="Amount">$<?php echo $dep['hAmt']; ?></td>
                          <td data-label="Gateway"><?php echo $dep['hGateway']; ?> Transfer</td>
                       </tr>
					   <?php } }else{ ?>
									<tr>
              ...
              <div class="tab-pane fade" id="withdraw" role="tabpanel" aria-labelledby="withdraw-tab">
                <div class="table-responsive--md">
                  <table class="table style--two">
                    ...
                    <tbody>
					<?php $query=mysqli_query($conn, "Select * from _withdraw join _users on _uId = wUser order by wId desc limit 10");
						if(mysqli_num_rows($query)>0){
						while($wit=mysqli_fetch_array($query)){ ?>
                      <tr>
						<td data-label="Name"><?php echo $wit['_fName']." ".$wit['_lName']; ?> </td>
                          <td data-label="Date"><?php echo $wit['wTime']; ?></td>
                          <td data-label="Amount">$<?php echo $wit['wAmt']; ?></td>
                          <td data-label="Gateway">USDT Transfer</td>
                       </tr>
					   <?php } }else{ ?>
									<tr>
										<td class="text-right" colspan="100%">No result found</td>
            ...
            <div class="payment-slider">
                ...
                <div class="brand-item">
                  <img src="assets/images/gateway/5f9a8b62bb4dd1603963746.png" alt="image">
                            ...
                            <div class="single-slide">
                <div class="brand-item">
                  <img src="assets/images/gateway/632d98069f2701663932422.jpg" alt="image">
                </div><!-- brand-item end -->
              </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              ...
              <p>you will get each update about our system and the world market in this area. Keep checking our Latest News to be in touch.</p>
            </div>
          </div>
        </div><!-- row end -->
        <div class="row mb-none-30">
            ...
            <div class="blog-card">
              ...
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="blog/details/voluptates-ratione-mollitia-sequi-quia-asperiores-sint/161.html">Al tech aims to make metaverse design accessible for creators</a></h5>
                
                <p>Mona, a Miami-based 3D metaverse development and Web3 social platform, unveiled an AI-powered 3D generator for material design. The tool allows designers and creators on the platform to input words into the AI mechanism to create materials for their personalized digital spaces.
                    The MonaAI Material Generator is similar to the AI image and design generator DALL-E. However, it focuses specifically on “seamless” and realistic textures to be used in a metaverse setting.</p>
                <a href="#" class="cmn-btn btn-md mt-4">Read More</a>
              </div>
            </div>
          </div>
            ...
            <div class="blog-card">
              ...
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="blog/details/amet-quisquam-ut-vitae-debitis-iste/160.html">Mark Zuckerberg's Meta Metaverse Legs Were Staged
                  The billionaire founder did say, "Seriously, legs are hard."</a></h5>
                
                <p>It's fair to say that nobody is more excited about Meta's future metaverse than billionaire CEO, co-founder and chairman Mark Zuckerberg. Note his utter delight when, earlier this week, he announced "one more feature coming soon that's probably the most requested feature on our road map."
                    "Legs!" he said. "I think everyone has been waiting for this!"</p>
                <a href="#" class="cmn-btn btn-md mt-4">Read More</a>
              </div>
            </div>
          </div>
            ...
            <div class="blog-card">
              ...
              <div class="blog-card__content">
                <h5 class="blog-card__title mb-2"><a href="blog/details/voluptatum-est-expedita-officia-eos/159.html">Metaverse is the future of finance. I</a></h5>
                
                <p>Fidelity Investments has said that “the metaverse is the next evolution of the internet – a 3D model of the internet.” One of the most monumental periods in time for finance as well as science, math and art – the Renaissance – did much the same thing.  Greats such as Michelangelo and Alberti perfected that use of linear perspective as a means of depicting three-dimensional depth in art. Today’s metaverse puts us on the same trajectory and fintech very well could be the means to getting there.   </p>
                <a href="#" class="cmn-btn btn-md mt-4">Read More</a>
              </div>
            </div>
          </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-lg-0 mt-4">
                  <form class="subscribe-form" method="post">
                    <input type="hidden" name="_token" value="RjewJ7FbUGqKO9kPxi3G8VMYIu84PptVCtxZdt8H">                    
...
<script>
    $("#planAmt").keyup(function(){
       ...
       var _percent = $("#changePlan").val(); 
       var _amt = $("#planAmt").val();
       var _ans = (_percent/100)*_amt;
       var _profit = ((+_ans)+(+_amt));
       $("#profitResult").val("Returns "+_profit+" USD at the End of the Plan");
       $(".period").html("Net Profit "+_profit);
       $(".period").show();
    ...
    <script>
        (function ($) {
          ...
          function ajaxPlanCalc(planId, investAmount) {
              $.ajax({
                  url: "https://bethertrade.com/planCalculator",
                  type: "post",
                  data: {
                      planId,
                      investAmount
