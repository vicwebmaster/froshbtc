...
<head>
  ...
  <meta name="csrf-token" content="RjewJ7FbUGqKO9kPxi3G8VMYIu84PptVCtxZdt8H">
    <title><?php echo $system['sitename']; ?>- Reset</title>
    ...
    <meta itemprop="name" content="Megavex-Trade - Home">
            ...
            <div class="account-card">
              ...
              <div class="account-card__body">
				...
				<div class="form-group">
                  ...
                  <div class="mt-3">
                    <button type="submit" class="cmn-btn" id="signinBtn">Reset Password</button>
...
<script>
  $("#_reset").submit(function(e){
      ...
      $("#loading").show();
      $.ajax({
          url:'dashboard/process/reset.php',
          method: 'POST',
          dataType: 'JSON',
          ...
          success:function(resp){
            ...
            if(resp.status===1){
              Swal.fire({
                title: 'Success',
                text: 'Visit your Mail Box to view your New Password',
                icon: 'success',
              })
            }else{ 
              Swal.fire({
