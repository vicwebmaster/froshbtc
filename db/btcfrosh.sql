...
-- Dumping data for table btcfrosh._admin: ~0 rows (approximately)
...
-- Dumping data for table btcfrosh._history: ~2 rows (approximately)
INSERT INTO `_history` (`hId`, `hUser`, `hTrx`, `hAmt`, `hGateway`, `hLink`, `hStatus`, `hDate`) VALUES
	(2, 1, 945199846, 7878, 'ETH', 'jkwrjhjh', 'Pending', '2023-10-09 19:02:26'),
	(3, 1, 32188714, 890, 'BTC', 'nvvv', 'Pending', '2023-10-09 19:04:55');
...
INSERT INTO `_users` (`_uId`, `_fName`, `_lName`, `_country`, `_uPhone`, `_uEmail`, `_userName`, `_uPassword`, `_Pic`, `_addr`, `_state`, `_zip`, `_city`, `_uStatus`, `_regTime`, `_depositBal`, `_interestBal`, `_totalInvest`, `_totalBal`, `_totalWithdraw`, `_referralEarn`, `_otp`, `_otpExpiry`, `_referredMe`, `_firstDeposit`) VALUES
	(1, 'Victor', 'Okafor', 'Nigeria', '23409014292469', 'okaffskido@gmail.com', 'vic', 'Me@11111', NULL, NULL, NULL, NULL, NULL, 'Active', '2023-07-10 09:53:10', 7, 0, 0, 7, 0, 0, '937387', '2023-07-11', '', 'Y');
